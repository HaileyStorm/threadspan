...
- New unpinned Codex work uses GPT-6 Astra at medium reasoning as the primary controller. Use low for routine bounded work when it is sufficient. Explicit user, picker, task, and project routes always win; never silently reroute them.

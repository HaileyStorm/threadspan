...
function normalizeMcpTaskArguments(args) {
  return {
    ...
    payloadClassification: args.payload_classification ?? args.payloadClassification,
...
const MCP_TOOLS = Object.freeze([
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        reasoning_effort: { type: "string", enum: ["low", "medium", "high", "max"], description: "Provider-specific effort override when supported and allowed by configuration." },
        ...
        payload_classification: { type: "string", enum: ["public_synthetic", "public_repo", "owner_private", "public_synthetic_image", "public_image"], description: "Required Grok saved-session classification. owner_private is explicit owner-authorized text transfer; image classifications remain public-only and apply only to bounded Responses data-URI image Consult." },
